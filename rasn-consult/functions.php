			...
			'layouts' => array(
                ...
                'layout_hero_infographic' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key'   => 'field_hi_sub_title',
                            'label' => 'Sub Title',
                            'name'  => 'sub_title',
                            'type'  => 'text',
                        ),
                        array(
                            'key'   => 'field_hi_right_title',
                            'label' => 'Title',
                            'name'  => 'right_title',
                            'type'  => 'text',
                        ),
                        array(
                            'key' => 'field_hi_info_tabs',
                            'label' => 'Info Tabs',
                            'name' => 'info_tabs',
                            'type' => 'repeater',
                            'layout' => 'table',
                            'button_label' => 'Add Info Tab',
                            'sub_fields' => array(
                                array(
                                    'key' => 'field_hi_info_tab_text',
                                    'label' => 'Tab Text',
                                    'name' => 'tab_text',
                                    'type' => 'text',
                                ),
                        ...
                        array(
                            'key'   => 'field_hi_right_desc',
                            'label' => 'Description',
                            'name'  => 'right_decription',
                            'type'  => 'textarea',
                            'rows'  => 3,
                            'instructions' => 'Use HTML like <span class="text-primary">...</span> for highlight.',
                        ),
                        array(
                            'key'          => 'field_hi_right_buttons',
                            'label'        => 'Buttons',
                            'name'         => 'right_buttons',
                            'type'         => 'repeater',
                            'layout'       => 'table',
                            ...
                            'sub_fields'   => array(
                                array(
                                    'key'   => 'field_hi_right_btn_text',
                                    'label' => 'Button Text',
                                    'name'  => 'text',
                                    'type'  => 'text',
                                ),
                                array(
                                    'key'   => 'field_hi_right_popup_make',
                                    'label' => 'Open Popup',
                                    'name'  => 'open_popup',
                                    'type'  => 'text',
                                ),
                                array(
                                    'key'   => 'field_hi_right_btn_icon',
                                    'label' => 'Icon',
                                    'name'  => 'icon',
                                    'type'  => 'font-awesome',
                                    'icon_sets' => array(
                                ...
                                array(
                                    'key'   => 'field_hi_right_btn_link',
                                    'label' => 'Button Link',
                                    'name'  => 'link',
                                    'type'  => 'link',
                                ),
                                array(
                                    'key'   => 'field_hi_right_btn_style',
                                    'label' => 'Button Style',
                                    'name'  => 'style',
                                    'type'  => 'select',
                                    'choices' => array(
                        ...
                        array(
                            'key' => 'field_hi_bottom_image',
                            'label' => 'Bottom Image',
                            'name' => 'hi_bottom_image',
                            'type' => 'image',
                            'return_format' => 'url',
                            'preview_size' => 'medium',
                        ),
                        array(
                            'key' => 'field_hi_info_counters',
                            'label' => 'Info Counters',
                            'name' => 'info_counters',
                            'type' => 'repeater',
                            'layout' => 'table',
                            'button_label' => 'Add Info Counter',
                            'sub_fields' => array(
                                array(
                                    'key' => 'field_hi_info_counter_number',
                                    'label' => 'Counter Number',
                                    'name' => 'hi_info_counter_number',
                                    'type' => 'text',
                                ),
                                array(
                                    'key' => 'field_hi_info_counter_suffix',
                                    'label' => 'Counter Suffix',
                                    'name' => 'hi_info_counter_suffix',
                                    'type' => 'text',
                                ),
                                array(
                                    'key' => 'field_hi_info_counter_text',
                                    'label' => 'Counter Text',
                                    'name' => 'hi_info_counter_text',
                                    'type' => 'text',
                                ),
                            ),
                        ),
                ...
                'layout_why_choose_us' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            ...
                            'sub_fields'   => array(
                                array(
                                    'key'   => 'field_why_choose_btn_text',
                                    'label' => 'Button Text',
                                    'name'  => 'text',
                                    'type'  => 'text',
                                ),
                                array(
                                    'key'   => 'field_why_choose_popup_make',
                                    'label' => 'Open Popup',
                                    'name'  => 'open_popup',
                                    'type'  => 'text',
                                ),
                                array(
                                    'key'   => 'field_why_choose_btn_icon',
                                    'label' => 'Icon',
                                    'name'  => 'icon',
                                    'type'  => 'font-awesome',
                                    'icon_sets' => array(
                                ...
                                array(
                                    'key'   => 'field_why_choose_btn_link',
                                    'label' => 'Button Link',
                                    'name'  => 'link',
                                    'type'  => 'link',
                                ),
                                array(
                                    'key'   => 'field_why_choose_btn_style',
                                    'label' => 'Button Style',
                                    'name'  => 'style',
                                    'type'  => 'select',
                                    'choices' => array(
                        ...
                        array(
                            'key' => 'field_why_choose_images',
                            'label' => 'Images',
                            'name' => 'why_choose_images',
                            'type' => 'gallery',
                            'preview_size' => 'medium',
                            'insert' => 'append',
                            'library' => 'all',
                            'min' => 3, // minimum images
                            'max' => 3, // maximum images
                        ),
                    ),
                    'min' => '',
                    'max' => '',
